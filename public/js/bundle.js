      ...
      while (1) switch (_context.p = _context.n) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "POST",
            url: "/api/v1/admin__portal/login",
            data: {
              email: email,
              password: password
            }
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "GET",
            url: "/api/v1/admin__portal/logout"
          });
        case 1:
          res = _context2.v;
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable */
var stripeKey = document.querySelector("body").dataset.stripeKey;
var stripe = Stripe(stripeKey);
var bookArtwork = exports.bookArtwork = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(artworkId) {
    var session, message, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          _context.n = 1;
          return (0, _axios.default)("/api/v1/orders/checkout-session/".concat(artworkId));
        case 1:
          session = _context.v;
          _context.n = 2;
        ...
        case 3:
          ...
          _t = _context.v;
          console.log(_t);
          message = _t.response && _t.response.data && _t.response.data.message ? _t.response.data.message : "Something went wrong! Please try again.";
  ...
  return function bookArtwork(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
exports.uploadArtwork = exports.updateArtwork = exports.toggleOrderFulfilled = exports.deleteArtwork = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _regenerator() { /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/babel/babel/blob/main/packages/babel-helpers/LICENSE */ var e, t, r = "function" == typeof Symbol ? Symbol : {}, n = r.iterator || "@@iterator", o = r.toStringTag || "@@toStringTag"; function i(r, n, o, i) { var c = n && n.prototype instanceof Generator ? n : Generator, u = Object.create(c.prototype); return _regeneratorDefine2(u, "_invoke", function (r, n, o) { var i, c, u, f = 0, p = o || [], y = !1, G = { p: 0, n: 0, v: e, a: d, f: d.bind(e, 4), d: function d(t, r) { return i = t, c = 0, u = e, G.n = r, a; } }; function d(r, n) { for (c = r, u = n, t = 0; !y && f && !o && t < p.length; t++) { var o, i = p[t], d = G.p, l = i[2]; r > 3 ? (o = l === n) && (u = i[(c = i[4]) ? 5 : (c = 3, 3)], i[4] = i[5] = e) : i[0] <= d && ((o = r < 2 && d < i[1]) ? (c = 0, G.v = n, G.n = i[1]) : d < l && (o = r < 3 || i[0] > n || n > l) && (i[4] = r, i[5] = n, G.n = l, c = 0)); } if (o || r > 1) return a; throw y = !0, n; } return function (o, p, l) { if (f > 1) throw TypeError("Generator is already running"); for (y && 1 === p && d(p, l), c = p, u = l; (t = c < 2 ? e : u) || !y;) { i || (c ? c < 3 ? (c > 1 && (G.n = -1), d(c, u)) : G.n = u : G.v = u); try { if (f = 2, i) { if (c || (o = "next"), t = i[o]) { if (!(t = t.call(i, u))) throw TypeError("iterator result is not an object"); if (!t.done) return t; u = t.value, c < 2 && (c = 0); } else 1 === c && (t = i.return) && t.call(i), c < 2 && (u = TypeError("The iterator does not provide a '" + o + "' method"), c = 1); i = e; } else if ((t = (y = G.n < 0) ? u : r.call(n, G)) !== a) break; } catch (t) { i = e, c = 1, u = t; } finally { f = 1; } } return { value: t, done: y }; }; }(r, o, i), !0), u; } var a = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} t = Object.getPrototypeOf; var c = [][n] ? t(t([][n]())) : (_regeneratorDefine2(t = {}, n, function () { return this; }), t), u = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(c); function f(e) { return Object.setPrototypeOf ? Object.setPrototypeOf(e, GeneratorFunctionPrototype) : (e.__proto__ = GeneratorFunctionPrototype, _regeneratorDefine2(e, o, "GeneratorFunction")), e.prototype = Object.create(u), e; } return GeneratorFunction.prototype = GeneratorFunctionPrototype, _regeneratorDefine2(u, "constructor", GeneratorFunctionPrototype), _regeneratorDefine2(GeneratorFunctionPrototype, "constructor", GeneratorFunction), GeneratorFunction.displayName = "GeneratorFunction", _regeneratorDefine2(GeneratorFunctionPrototype, o, "GeneratorFunction"), _regeneratorDefine2(u), _regeneratorDefine2(u, o, "Generator"), _regeneratorDefine2(u, n, function () { return this; }), _regeneratorDefine2(u, "toString", function () { return "[object Generator]"; }), (_regenerator = function _regenerator() { return { w: i, m: f }; })(); }
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable */
var uploadArtwork = exports.uploadArtwork = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          ...
          (0, _alerts.showAlert)("success", "Artwork uploaded successfully!");
...
var deleteArtwork = exports.deleteArtwork = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "DELETE",
            url: "/api/v1/admin__portal/delete/".concat(id)
          });
        case 1:
          res = _context2.v;
          if (!(res.status === 204)) {
          ...
          (0, _alerts.showAlert)("success", "Artwork deleted successfully!");
        ...
        case 3:
          _context2.p = 3;
          _t2 = _context2.v;
          (0, _alerts.showAlert)("error", "Error deleting artwork! Try again.");
  ...
  return function deleteArtwork(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
var updateArtwork = exports.updateArtwork = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "PATCH",
            url: "/api/v1/admin__portal/update/".concat(id),
            data: data
          });
        case 1:
          res = _context3.v;
          ...
          (0, _alerts.showAlert)("success", "Artwork updated successfully!");
          return _context3.a(2, res.data.data.artwork);
        case 2:
          _context3.n = 4;
          break;
        case 3:
          _context3.p = 3;
          _t3 = _context3.v;
          (0, _alerts.showAlert)("error", _t3.response.data.message || "Error updating artwork!");
  ...
  return function updateArtwork(_x3, _x4) {
    return _ref3.apply(this, arguments);
  };
}();
var toggleOrderFulfilled = exports.toggleOrderFulfilled = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.p = _context4.n) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "PATCH",
            url: "/api/v1/admin__portal/order/".concat(id, "/fulfill")
          });
        case 1:
          res = _context4.v;
          if (!(res.data.status === "success")) {
          ...
          (0, _alerts.showAlert)("success", "Order status updated!");
          return _context4.a(2, res.data.data.order);
        case 2:
          _context4.n = 4;
          break;
        case 3:
          _context4.p = 3;
          _t4 = _context4.v;
          (0, _alerts.showAlert)("error", "Error updating order status!");
  ...
  return function toggleOrderFulfilled(_x5) {
...
var bookBtns = document.querySelectorAll(".btn--buy");
var adminTabs = document.querySelectorAll(".admin-tab");
var adminForms = document.querySelectorAll(".admin-form");
var formForSale = document.getElementById("form-for-sale");
var formSold = document.getElementById("form-sold");
var deleteBtns = document.querySelectorAll(".btn--delete");
var updateForms = document.querySelectorAll(".inventory-card__form");
var fulfillBtns = document.querySelectorAll(".btn--fulfill");
...
if (bookBtns) {
  bookBtns.forEach(function (btn) {
    btn.addEventListener("click", function (e) {
      ...
      var artworkId = e.target.dataset.artworkId;
      (0, _stripe.bookArtwork)(artworkId);
    });
  });
}
if (formForSale) {
  formForSale.addEventListener("submit", /*#__PURE__*/function () {
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            ...
            form.append("description", document.getElementById("description-sale").value);
            form.append("colorPalette", document.getElementById("colorPalette-sale").value);
            ...
            _context.n = 1;
            return (0, _admin.uploadArtwork)(form);
          case 1:
            success = _context.v;
            if (success) {
...
if (formSold) {
  formSold.addEventListener("submit", /*#__PURE__*/function () {
      ...
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.n) {
          case 0:
            ...
            form.append("description", document.getElementById("description-sold").value);
            form.append("colorPalette", document.getElementById("colorPalette-sold").value);
        ...
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.n) {
            case 0:
              ...
              _context3.n = 1;
              return (0, _admin.deleteArtwork)(id);
            case 1:
              success = _context3.v;
              if (success) {
                card = e.target.closest(".inventory-card");
                if (card) card.remove();
              }
            case 2:
              return _context3.a(2);
  ...
  updateForms.forEach(function (form) {
    form.addEventListener("submit", /*#__PURE__*/function () {
      var _ref4 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(e) {
        var id, discountInput, discountPercent, updatedArtwork, card, priceBox;
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.n) {
            case 0:
              e.preventDefault();
              id = e.target.dataset.id;
              discountInput = document.getElementById("discount-".concat(id));
              discountPercent = discountInput.value;
              _context4.n = 1;
              return (0, _admin.updateArtwork)(id, {
                discountPercent: discountPercent
              });
            case 1:
              updatedArtwork = _context4.v;
              if (updatedArtwork) {
                card = e.target.closest(".inventory-card");
                priceBox = card.querySelector(".inventory-card__price-box");
                if (updatedArtwork.priceDiscount) {
                  priceBox.innerHTML = "\n            <span class=\"inventory-card__price inventory-card__price--old\">$".concat(updatedArtwork.price, "</span>\n            <span class=\"inventory-card__price inventory-card__price--new\">$").concat(updatedArtwork.priceDiscount, "</span>\n          ");
                } else {
                  priceBox.innerHTML = "<span class=\"inventory-card__price\">$".concat(updatedArtwork.price, "</span>");
                }
              }
            case 2:
              return _context4.a(2);
        ...
        return _regenerator().w(function (_context5) {
          while (1) switch (_context5.n) {
            case 0:
              ...
              _context5.n = 1;
              return (0, _admin.toggleOrderFulfilled)(orderId);
            case 1:
...
if (adminTabs) {
  adminTabs.forEach(function (tab) {
    tab.addEventListener("click", function (e) {
      ...
      var formToShow = document.querySelector("#form-".concat(tabName));
      if (formToShow) {
